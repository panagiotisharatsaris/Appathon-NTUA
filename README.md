...
#### Βήμα 5
Αφού ενεργοποιήσαμε του servers απομένει να κάνουμε parse τα δεδομένα που θέλουμε απο τα αρχεία xml στην SQL.Για να το κάνουμε αυτό στον φάκελο Appathon-NTUA (που έχουμε μετακινησεί στον φάκελο του xampp) ανοίγουμε ένα terminal και τρέχουμε την εντολή ./parse.py /path/to/AllPublicXML/folder για να τρέξει το script που κάνει το parse των δεδομένων.Η διαδικασία αυτή παίρνει λίγη ώρα λόγω του μεγάλου όγκου των αρχείων. Για την διαδικασία αυτή πρέπει να εγκαταστήσουμε το πακέτο mysqlconnector της python (pip3 install mysql.connector).
